...
<p>
  ...
  *TESS-cont* is a **user-friendly** tool to **compute the flux** from **nearby stars** in the **TESS aperture** of **any observed target**. The package **(1)** identifies the main contaminant *Gaia* DR2/DR3 sources, **(2)** quantifies their individual and total flux contributions to the aperture, and **(3)** determines whether any of these stars could be the origin of the observed **transit** and **variability** signals.
