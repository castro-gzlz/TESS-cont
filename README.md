...
The *TESS-cont* algorithm is based on building the PRFs of nearby *Gaia* sources and computing their flux distributions across the TESS TPFs/FFIs. A more detailed description can be found in Section 2.1.2 of [this work](https://ui.adsabs.harvard.edu/abs/2024arXiv240918129C/abstract).
