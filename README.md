...
In this example, we study the star TOI-4479. As we can see, the field is **less crowded** (there are less white disks) but the SPOC photometry is **more contaminated**, with a total contamination fraction of **30.4%**. 
