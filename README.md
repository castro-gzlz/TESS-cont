...
This star was found to have a planet candidate, TOI-4479.01, with a transit depth of 3471 ppm (parts per million) according to ExoFOP, which was later confirmed to be a planet by Esparza-Borges et al. (2022) with follow-up observations. We here used the *TESS-cont* **DILUTION** feature to know whether we can discard the nearby contaminant sources as being the origin of the signal found based on the TESS photometry alone. 
