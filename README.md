...
**Other uses**. *TESS-cont* can be also used to **generate custom apertures** based on the computed pixel-by-pixel contamination. We can select a certain threshold (e.g. 60%) of flux coming from the target star, and generate and save an aperture that meets such a threshold. This feature 
